...
// API endpoint — simulates returning user data
app.get('/api/users', (req, res) => {
  db.query('SELECT id, name, email, created_at FROM users LIMIT 10', (err, results) => {
    if (err) {
...
app.listen(PORT, () => {
  ...
  console.log(`[${SERVICE_NAME}] API:          http://localhost:${PORT}/api/users`);
});
