...
// API endpoint — simulates returning inventory data
app.get('/api/inventory', (req, res) => {
  db.query('SELECT id, product_name, sku, quantity, price, updated_at FROM inventory LIMIT 10', (err, results) => {
    if (err) {
...
app.listen(PORT, () => {
  ...
  console.log(`[${SERVICE_NAME}] API:          http://localhost:${PORT}/api/inventory`);
});
